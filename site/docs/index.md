...
[![License: Apache-2.0](https://img.shields.io/github/license/MelaBuilt-AI/agentclutch)](https://github.com/MelaBuilt-AI/agentclutch/blob/main/LICENSE)
[![TypeScript](https://img.shields.io/badge/TypeScript-strict-blue)](https://github.com/MelaBuilt-AI/agentclutch/blob/main/tsconfig.base.json)
...
![Screenshot: FakeStore checkout Action Card overlay](https://raw.githubusercontent.com/MelaBuilt-AI/agentclutch/main/docs/assets/fakestore-action-card-overlay.png)
...
![Screenshot: Action Card viewer rendering sample checkout card](https://raw.githubusercontent.com/MelaBuilt-AI/agentclutch/main/docs/assets/action-card-viewer-screenshot.png)
...
- [Examples index](https://github.com/MelaBuilt-AI/agentclutch/blob/main/examples/README.md)

## Documentation

- [Quickstart](quickstart.md)
- [npm publishing notes](npm-publishing.md)
- [Known limitations](limitations.md)
- [Security policy](https://github.com/MelaBuilt-AI/agentclutch/blob/main/SECURITY.md)
- [Launch announcement drafts](launch-announcement-drafts.md)
- [Demo script](demo-script.md)
- [Launch checklist](launch-checklist.md)
- [Architecture](architecture.md)
- [Action Cards](action-cards.md)
- [Loops](loops.md)
- [Playwright Adapter](playwright.md)
- [React Components](react-components.md)
- [Recorder](recorder.md)
- [Run Story](run-story.md)
