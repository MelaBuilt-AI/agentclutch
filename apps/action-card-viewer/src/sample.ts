import { buildActionCard, type ActionCard, type RunStoryStep } from "@agentclutch/action-card";
...
export const sampleRunSteps: RunStoryStep[] = [
  {
    timestamp: "2026-06-22T04:00:00.000Z",
    actor: "agent",
    action_card_id: "acard_sample_checkout",
    text: "The agent proposed completing checkout for Wireless Headphones Pro."
  },
  {
    timestamp: "2026-06-22T04:00:10.000Z",
    actor: "system",
    action_card_id: "acard_sample_checkout",
    text: "AgentClutch rendered an Action Card for the consequential checkout action."
  },
  {
    timestamp: "2026-06-22T04:00:20.000Z",
    actor: "user",
    decision_id: "decision_sample",
    action_card_id: "acard_sample_checkout",
    text: "The user can approve, edit, take over, block, or create a rule."
  }
];
